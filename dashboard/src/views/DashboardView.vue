  ...
  <div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div
        ...
        :key="card.key"
        class="bg-gray-800 border border-gray-700 p-4 flex items-center gap-4 transition-all duration-200 hover:border-gray-600"
      >
        ...
        <div class="flex-1">
          <div class="text-xs text-gray-500 font-mono mb-1">{{ card.title }}</div>
          <div class="text-2xl font-mono text-gray-300 font-medium">{{ card.value.toLocaleString() }}</div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="bg-gray-800 border border-gray-700 overflow-hidden">
        <div class="flex items-center gap-2 px-4 py-3 border-b border-gray-700">
          ...
          <h3 class="text-sm font-mono text-gray-300">Why-Log 统计</h3>
        </div>
        <div class="p-4" v-if="logStats">
          <div class="flex justify-between items-center py-3 border-b border-gray-700">
            <span class="text-xs text-gray-500 font-mono">平均奖励</span>
            <span
          ...
          <div class="flex justify-between items-center py-3">
            <span class="text-xs text-gray-500 font-mono">评估率</span>
      ...
      <div class="bg-gray-800 border border-gray-700 overflow-hidden">
        <div class="flex items-center gap-2 px-4 py-3 border-b border-gray-700">
          ...
          <h3 class="text-sm font-mono text-gray-300">RL 模型统计</h3>
        </div>
        <div class="p-4" v-if="modelStats">
          <div class="flex justify-between items-center py-3 border-b border-gray-700">
            <span class="text-xs text-gray-500 font-mono">模型版本</span>
            <span
          ...
          <div class="flex justify-between items-center py-3 border-b border-gray-700">
            <span class="text-xs text-gray-500 font-mono">检查点数量</span>
            <span class="text-sm font-mono font-medium text-gray-300">
              {{ modelStats.checkpoints_count }}
            </span>
          </div>
          <div class="flex justify-between items-center py-3">
            <span class="text-xs text-gray-500 font-mono">最近 30 天样本</span>
            <span class="text-sm font-mono font-medium text-gray-300">
